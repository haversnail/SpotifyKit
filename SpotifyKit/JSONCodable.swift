...
//
// In lieu of using the KeyedDecodingContainer extension above, the following
// approach provides a more succinct solution to the case-sensitive conflicts
// between raw values and raw representable types. Instead of specifying a case
// when decoding each property individually, this approach implicitly converts
// between lowercase, uppercase, and sentence cases before throwing an error
// any time we decode a raw representable type.
//
