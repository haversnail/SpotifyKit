...
///
/// The `User` protocol serves as the base protocol to which all Spotify user types conform. Its requirements include all the publicly available properties of a user. See the Spotify Web API [Object Model](https://developer.spotify.com/documentation/web-api/reference/object-model/#user-object-public) for more details.
public protocol User {
    
    /// The name displayed on the user's profile. `nil` if not available.
    var displayName: String? { get }
    
    /// Known external URLs for this user. See ["external URL object"](https://developer.spotify.com/documentation/web-api/reference/object-model/#external-url-object) for more details.
...
/// A Spotify user.
///
/// - SeeAlso: The Web API [Public User](https://developer.spotify.com/documentation/web-api/reference/object-model/#user-object-public) object.
...
///
/// - SeeAlso: The Web API [Private User](https://developer.spotify.com/documentation/web-api/reference/object-model/#user-object-private) object.
public struct SKCurrentUser: User, JSONDecodable {
    ...
    /// - Note: This field is only available when the current user has granted access to the `user-read-birthdate` scope. See [Authorization Scopes](https://developer.spotify.com/documentation/general/guides/scopes/) for more details.
    ...
    /// - Note: This field is only available when the current user has granted access to the `user-read-private` scope. See [Authorization Scopes](https://developer.spotify.com/documentation/general/guides/scopes/) for more details.
    public let country: String?
    
    /// The user's email address, as entered by the user when creating their account.
    /// - Important: This email address is unverified; there is no proof that it actually belongs to the user.
    /// - Note: This field is only available when the current user has granted access to the `user-read-email` scope. See [Authorization Scopes](https://developer.spotify.com/documentation/general/guides/scopes/) for more details.
